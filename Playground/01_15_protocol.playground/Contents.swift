...
// 구조체, 클래스, 열거형은 프로토콜을 채택(Adopted) 해서 특정 기능을 수행하기 위한 프로토콜의 요구사항을 실제로 구현 가능
// 어떤 프로토콜의 요구사항을 모두 따르는 타입은 그 프로토콜을 준수한다(Conform) 고 표현
// 타입에서 프로토콜의 요구사항을 충족시키려면 프로토콜이 제시하는 청사진의 기능을 모두 구현 해야함
// 즉, 프로토콜은 기능을 정의하고 제시 할 뿐이지 스스로 기능을 구현 X
...
//    var language: String { return "한국어" }
    ...
    // 물론 읽기, 쓰기 프로퍼티도 연산 프로퍼티로 대체할 수 있슴
//    var subject: String = ""
//    var topic: String {
//        set {
